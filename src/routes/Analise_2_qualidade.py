...
from src.models import Analise_2_qualidade, Produtos_CSW
...
@Analise_2_qualidade_routes.route('/api/defeitos_fornecedor_agrupo_periodo', methods=['GET'])
@token_required
def get_defeitos_fornecedor_agrupo_periodo():
    codEmpresa = request.args.get('codEmpresa', '1')
    data_inicio = request.args.get('data_inicio', '-')
    data_fim = request.args.get('data_fim', '-')
...
@Analise_2_qualidade_routes.route('/api/defeitos_fornecedor_base_agrupo_periodo', methods=['GET'])
@token_required
def get_defeitos_fornecedor_base_agrupo_periodo():
    codEmpresa = request.args.get('codEmpresa', '1')
    data_inicio = request.args.get('data_inicio', '-')
    data_fim = request.args.get('data_fim', '-')
...
@Analise_2_qualidade_routes.route('/api/defeitos_detalhado_periodo', methods=['GET'])
@token_required
def get_defeitos_detalhado_periodo():
    codEmpresa = request.args.get('codEmpresa', '1')
    data_inicio = request.args.get('data_inicio', '-')
    data_fim = request.args.get('data_fim', '-')
...
@Analise_2_qualidade_routes.route('/api/defeitos_origem_periodo', methods=['GET'])
@token_required
def get_defeitos_origem_periodo():
    codEmpresa = request.args.get('codEmpresa', '1')
    data_inicio = request.args.get('data_inicio', '-')
    data_fim = request.args.get('data_fim', '-')
...
@Analise_2_qualidade_routes.route('/api/testeApi', methods=['GET'])
@token_required
def get_testeApi():
    codEmpresa = request.args.get('codEmpresa', '1')
    data_inicio = request.args.get('data_inicio', '-')
    ...
    dados = Produtos_CSW.Produtos_CSW(codEmpresa).materiais_requisicao_OP_csw(data_inicio)
    #controle.salvarStatus(rotina, ip, datainicio)
