...
class MonitorPedidosOP():
    ...
    def __salvando_e_finalizando_calculo_monitor(self):
        ...
        pedidos["nomeCliente"] = pedidos["nomeCliente"].astype(str)#nomeEstado
    ...
    def geracao_monitor_op(self):
        ...
        monitor.to_csv(f'/home/grupompl/ModuloPCP_confeccaoMPL/dados/monitorOps{self.descricaoArquivo}.csv')
