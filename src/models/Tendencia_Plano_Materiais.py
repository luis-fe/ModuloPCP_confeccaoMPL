...
class Tendencia_Plano_Materiais():
    ...
    def detalhaNecessidade(self, simulacao):
        ...
        if simulacao == 'nao':
            ...
            Necessidade = pd.read_csv(f'{caminho_absoluto}/dados/EstruturacaoPrevisao{self.codPlano}_{self.nomeSimulacao}.csv')
    ...
    def calculoIdealPcs_para_materiaPrima(self, simulacao = 'nao', arrayFiltroCategoria = ''):
        ...
        if simulacao == 'nao':
            ...
            Necessidade = pd.read_csv(f'{caminho_absoluto2}/dados/EstruturacaoPrevisao{self.codPlano}_{self.nomeSimulacao}.csv')
